...
- Upload avatar/logo tổ chức (`purpose=avatar`/`org_logo`) — backend đã hỗ trợ (validator đã kiểm tra
  content-type ảnh cho 2 purpose này) nhưng chưa có UI nào gọi tới ở cả 2 app.
