...
<!--
Vendored (copy-code, không phải package) từ https://github.com/leonxlnx/taste-skill (MIT License —
xem file LICENSE cùng thư mục), bản v2 (design-taste-frontend), lấy ngày 2026-08-02. Áp dụng cho khu
vực Client (`web/`, Next.js) theo đúng phạm vi skill tự khai báo ở dòng dưới — KHÔNG áp dụng cho
`web-admin/` (Admin/Vận hành là dashboard nội bộ, xem ADR-0007/0008). Xem
docs/kien-truc/TONG-QUAN-KIEN-TRUC.md và CLAUDE.md mục 7 để biết khi nào dùng skill này.
-->
